...
const Navbar = () => {
  ...
  return (
    ...
    <Link to='/' className="group relative flex flex-col items-start no-underline w-fit">
  <div className="flex items-center gap-3">
    {/* Algorithmic Arrow Mark */}
    <div className="flex items-center space-x-[2px]">
      <div className="h-5 w-[1px] bg-white opacity-30 transition-opacity duration-300 group-hover:opacity-100"></div>
      <div className="h-5 w-[2px] bg-white opacity-60 transition-opacity duration-300 group-hover:opacity-100"></div>
      <div className="h-5 w-[3px] bg-white opacity-90 transition-opacity duration-300 group-hover:opacity-100"></div>
      <div className="h-5 w-0 bg-white transition-all duration-500 ease-out group-hover:w-[4px] opacity-100"></div>
    </div>
    
    {/* Typography */}
    <h1 className="text-xl sm:text-2xl font-light tracking-[0.1em] text-white uppercase transition-all duration-300 group-hover:text-white">
      Prompt<span className="font-bold tracking-tighter">Synth</span>
    </h1>
  </div>

  {/* Underline Animation */}
  <span className="ml-[28px] mt-1.5 h-[1px] w-0 bg-white/70 transition-all duration-500 ease-in-out group-hover:w-[calc(100%-28px)] group-hover:bg-white"></span>
</Link>
